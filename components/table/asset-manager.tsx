  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap gap-2 min-h-[24px]">
        ...
        {linkAssets.map((asset) => (
          ...
          >
            ...
            <InteractiveLink
              href={asset.value}
              className="max-w-[140px] text-foreground/80 hover:text-primary transition-colors"
            >
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <Select value={inputState.type} onValueChange={(value) => onInputChange('type', value)}>
          <SelectTrigger
            aria-label="Selecionar tipo de asset"
            className="h-8 w-[110px] text-xs bg-background/50"
          >
